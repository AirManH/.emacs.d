...
(custom-set-variables
 ...
 '(package-selected-packages
   '(highlight-indent-guides yaml-mode doom-modeline highlight-thing delight company-posframe texmathp posframe pyim cmake-mode cnfonts srefactor company-c-headers sr-speedbar flycheck smex simple-httpd company-anaconda anaconda-mode spacemacs-theme vmd-mode counsel rainbow-delimiters use-package format-all lua-mode hungry-delete company smartparens monokai-theme))
